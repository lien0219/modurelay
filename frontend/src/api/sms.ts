...
export interface SMSCountryItem { iso2: string; iso3?: string; calling_code?: string; name_zh?: string; name_en?: string; provider_code?: string; stock?: number; provider_cost?: number; available?: boolean }
...
export const smsAPI = {
  ...
  quotes: (params: { provider?: string; service: string; country: string; product_type: 'temporary' | 'rental'; operator?: string; voice_mode?: number }) => apiClient.get<SMSQuote[]>('/sms/quotes', { params }).then(r => r.data),
