...
export const smsAPI = {
  ...
  resend: (id: string, idempotencyKey: string) => apiClient.post(`/sms/orders/${encodeURIComponent(id)}/resend`, undefined, { headers: { 'Idempotency-Key': idempotencyKey } }).then(r => r.data),
