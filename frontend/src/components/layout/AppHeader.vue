<template>
  <header class="app-header sticky top-0 z-30 border-b border-[color:var(--mr-border)]">
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        <div class="app-page-heading hidden sm:block">
          <h1 class="max-w-[34vw] text-base font-semibold text-[color:var(--color-text-primary)] lg:max-w-none lg:text-lg">
            {{ pageTitle }}
          </h1>
          <p v-if="pageDescription" class="hidden text-xs text-[color:var(--color-text-muted)] lg:block">
            {{ pageDescription }}
          </p>
        </div>
      </div>
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="app-header-action hidden items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium sm:flex"
        >
        ...
        <div
          v-if="user"
          class="app-header-balance group relative hidden items-center gap-2 rounded-xl px-3 py-1.5 sm:flex"
        >
          <svg
          ...
          >
            <div class="flex items-center justify-between">
              <span class="app-menu-meta">{{ balanceAvailableText }}</span>
              <span class="font-medium text-[color:var(--color-text-primary)]">{{ formatHeaderMoney(availableBalance) }}</span>
            </div>
            <div class="mt-2 flex items-center justify-between">
              <span class="app-menu-meta">{{ balanceFrozenText }}</span>
              <span class="font-medium text-amber-700 dark:text-amber-200">{{ formatHeaderMoney(frozenBalance) }}</span>
            </div>
            <div class="app-menu-divider mt-2 border-t pt-2">
              <div class="flex items-center justify-between">
                <span class="app-menu-meta">{{ balanceTotalText }}</span>
                <span class="font-semibold text-[color:var(--color-text-primary)]">{{ formatHeaderMoney(totalBalance) }}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="app-user-trigger flex items-center gap-2 rounded-xl p-1.5"
            :aria-label="t('common.userMenu')"
          >
            <div class="app-header-avatar flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl text-sm font-medium text-white">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
            ...
            <div class="hidden text-left md:block">
              ...
              <div class="app-menu-meta text-xs">
          ...
          <AnimatePresence>
            ...
            >
              <!-- User Info -->
              <div class="app-menu-divider border-b px-4 py-3">
                <div class="text-sm font-medium text-[color:var(--color-text-primary)]">
                  {{ displayName }}
                </div>
              ...
              <!-- Balance (mobile only) -->
              <div class="app-menu-divider border-b px-4 py-2 sm:hidden">
                <div class="app-menu-meta text-xs">
                  {{ t('common.balance') }}
                </div>
              ...
              <div
                v-if="contactInfo"
                class="app-menu-divider border-t px-4 py-2.5"
              >
              ...
              <div v-if="showOnboardingButton" class="app-menu-divider border-t py-1">
              ...
              <div class="app-menu-divider border-t py-1">
                <button
                  @click="handleLogout"
