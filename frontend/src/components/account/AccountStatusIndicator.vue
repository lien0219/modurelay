<template>
  <div class="flex items-center gap-2">
    ...
    <div v-if="hasError && account.error_message" class="group/error relative">
      ...
      <!-- Tooltip - 向下显示 -->
      <div
        class="invisible absolute left-0 top-full z-[100] mt-1.5 min-w-[200px] max-w-[300px] rounded-lg bg-gray-800 px-3 py-2 text-xs text-white opacity-0 shadow-xl transition-ui duration-200 group-hover/error:visible group-hover/error:opacity-100 dark:bg-gray-900"
      >
