<template>
  <BulkActionBar :show="true" :selected-count="selectedIds.length">
    <template #meta>
    ...
    <template v-if="selectedIds.length > 0">
      <button type="button" @click="$emit('delete')" class="btn btn-danger btn-sm">
        {{ t('admin.accounts.bulkActions.delete') }}
      </button>
      <button type="button" @click="$emit('reset-status')" class="btn btn-secondary btn-sm">
      ...
      <button type="button" @click="$emit('toggle-schedulable', false)" class="btn btn-warning btn-sm">
        {{ t('admin.accounts.bulkActions.disableScheduling') }}
      </button>
      <button type="button" @click="$emit('edit-selected')" class="btn btn-primary btn-sm">
