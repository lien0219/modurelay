<template>
  <div class="card">
    ...
    <div class="space-y-3 p-4">
      <button @click="router.push('/keys')" class="group flex w-full items-center gap-4 rounded-xl bg-gray-50 p-4 text-left transition-ui duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/usage')" class="group flex w-full items-center gap-4 rounded-xl bg-gray-50 p-4 text-left transition-ui duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
      ...
      <button v-if="canUseBatchImage" @click="router.push('/batch-image')" class="group flex w-full items-center gap-4 rounded-xl bg-gray-50 p-4 text-left transition-ui duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/redeem')" class="group flex w-full items-center gap-4 rounded-xl bg-gray-50 p-4 text-left transition-ui duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
