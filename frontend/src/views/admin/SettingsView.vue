              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "ModuRelay") +
                        " 100 " +
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/lien0219/modurelay/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/lien0219/modurelay/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/lien0219/modurelay/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/lien0219/modurelay/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
...
const form = reactive<SettingsForm>({
  ...
  site_name: "ModuRelay",
  site_logo: "",
  site_subtitle: "Connect once. Route any model.",
  api_base_url: "",
  contact_info: "",
  doc_url: "",
  home_content: "",
