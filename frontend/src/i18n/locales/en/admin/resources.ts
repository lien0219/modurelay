export default {
    resourceCenter: {
      ...
      description: 'Manage forum visibility, publishing rules, and moderation',
      enabled: 'Show forum entry',
      enabledHint: 'When disabled, the user sidebar entry and content access are hidden.',
      forbidUrls: 'Block URL links',
      forbidUrlsHint: 'When enabled, posts and comments containing http, https, or www links are rejected.',
      bannedWords: 'Prohibited words',
      bannedWordsHint: 'One word per line. Matching content is rejected automatically.',
      save: 'Save settings',
      saved: 'Forum settings saved',
      posts: 'Post review',
      ...
      confirmDeletePost: 'Delete this post and its comments?',
      ...
      endDate: 'End date',
      selectPage: 'Select actionable items on this page',
      batchDelete: 'Batch delete',
      confirmBatchDelete: 'Delete the selected {count} items?',
