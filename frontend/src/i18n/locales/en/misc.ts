export default {
  ...
  resourceCenter: {
    title: 'Forum',
    description: 'Share experience, exchange ideas, and solve problems together',
    disclaimer: 'Community content is posted by users. Please verify information carefully and protect your personal privacy. Only accounts marked “Administrator” represent ModuRelay officially.',
    ...
    heroEyebrow: 'ModuRelay Community',
    heroTitle: 'Connect with developers and share what works',
    heroDescription: 'Share hands-on experience, discuss practical approaches, ask questions, and learn, collaborate, and grow with more developers.',
    statsPosts: 'Posts',
    statsCategories: 'Categories',
    statsUnread: 'Unread activity',
    statsVisible: 'Visible now',
    activityEyebrow: 'Community activity',
    guideEyebrow: 'Community guide',
    guideTitle: 'Keep discussions friendly and useful',
    guideRespectTitle: 'Be constructive',
    guideRespectDescription: 'Respect different viewpoints and keep the discussion focused on the problem or experience itself.',
    guideVerifyTitle: 'Share context',
    guideVerifyDescription: 'Share real usage experience, solution ideas, and reproducible practical details when possible.',
    guideSafetyTitle: 'Check information carefully',
    guideSafetyDescription: 'Verify links, accounts, prices, and service information before taking action.',
    categoryEyebrow: 'Browse topics',
    sortLabel: 'Sort posts',
    emptyTitle: 'No posts found',
    composerEyebrow: 'Start a discussion',
    composerDescription: 'A clear title and useful context help the community understand your post faster.',
    postTitlePlaceholder: 'Summarize the topic in one sentence',
    composerSafetyHint: 'Do not publish secrets, API keys, or unverified transaction information.',
    discussionEyebrow: 'Discussion',
    noCommentsTitle: 'No comments yet',
    commentSafetyHint: 'Keep the discussion constructive and avoid sharing sensitive information.',
  },
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to ModuRelay',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">ModuRelay is an open-source AI gateway for multi-provider routing, account pooling, usage metering and API management.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are a core ModuRelay concept, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to ModuRelay',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the ModuRelay AI gateway.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
