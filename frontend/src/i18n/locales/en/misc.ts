export default {
  ...
  resourceCenter: {
    ...
    heroDescription: 'Exchange practical experience, share patterns, ask questions, and build better AI applications together with other developers.',
    statsPosts: 'Posts',
    ...
    guideTitle: 'Keep discussions useful',
    guideRespectTitle: 'Be constructive',
    guideRespectDescription: 'Respect other viewpoints and focus on the problem or experience.',
    guideVerifyTitle: 'Share context',
    guideVerifyDescription: 'Include reproducible context and first-hand usage details when possible.',
    guideSafetyTitle: 'Verify independently',
    guideSafetyDescription: 'Check links, accounts, prices, and services before acting on them.',
