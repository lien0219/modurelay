export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description:
          'Configure Grok CLI, Claude Code, Codex, or OpenCode to send requests through your ModuRelay Grok group. Text models use Responses; image/video use Imagine model IDs on media endpoints.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your ModuRelay Grok group.',
  ...
  redeem: {
    ...
    balanceAddedActivity: 'Balance Added (Activity Reward)',
