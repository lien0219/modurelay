export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your ModuRelay Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your ModuRelay Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your ModuRelay Grok group.',
