export default {
  ...
  sms: {
    ...
    user: {
      ...
      quantity: 'Quantity',
      batchPurchaseHint: 'Buy 1-50 numbers; each order is settled independently.',
      cancel: 'Cancel',
      extend: 'Extend',
