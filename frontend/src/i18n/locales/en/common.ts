export default {
  ...
  sms: {
    ...
    user: {
      ...
      restoreRentalConfirmMessage: 'Restore the {service} rental for about {days} day(s) at {price} USD? The provider may allocate a new number.',
