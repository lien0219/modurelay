export default {
  ...
  sms: {
    ...
    user: {
      ...
      stepChannelTitle: 'Choose channel',
      stepChannelDescription: 'Choose an access channel. Number inventory can differ between channels.',
      publicChannels: 'Public channels',
      channelReady: 'Stable and available',
      channelReadySelected: 'Stock available',
      stepServiceTitle: 'Choose service',
      stepServiceDescription: 'Choose the website, app, or platform that should receive the verification code.',
      stepCountryTitle: 'Choose country / region',
      stepCountryDescription: 'Choose the country or region for the phone number.',
      stepConfirmTitle: 'Confirm selection',
      stepConfirmDescription: 'Review the selection. After quoting, a temporary number will be allocated.',
      stepConfirmRentalDescription: 'Review the selection, duration, and quantity before purchasing a long-term number.',
      quoteOptionsEyebrow: 'Live quotes',
      quoteOptionsTitle: 'Other available quotes',
      liveOrdersTitle: 'Receiving codes ({count})',
      liveOrdersDescription: 'Verification codes refresh automatically while the order is active.',
      channel: 'Channel',
