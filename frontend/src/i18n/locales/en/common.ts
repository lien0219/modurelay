export default {
  ...
  sms: {
    ...
    user: {
      ...
      errors: { unavailable: 'SMS service is temporarily unavailable.', quote: 'Could not load quotes.', orders: 'Could not load orders.', purchase: 'Purchase failed; refresh orders to confirm the balance state.', insufficientStock: 'This channel does not have enough stock for the requested quantity.', providerNoStock: '5SIM has no matching numbers available. Refresh the quote or choose another country/operator.', providerPriceLimit: 'The current 5SIM price is above this quote limit. Refresh the quote and try again.', providerBalanceLow: 'The 5SIM provider account balance is too low. Contact an administrator.', providerRateLimited: '5SIM API requests are being rate limited. Please try again shortly.', providerAuthFailed: '5SIM authentication failed. An administrator should check the provider credential.', providerCountryInvalid: 'The 5SIM country mapping is invalid. An administrator should check the mapping.', providerOperatorInvalid: 'The 5SIM operator selection is invalid. Choose another operator or contact an administrator.', providerServiceInvalid: 'The 5SIM service mapping is invalid. An administrator should check the mapping.', providerUpstreamError: '5SIM is temporarily returning a server error. Please try again later.', cancel: 'Cancellation failed.', cancelTooEarly: 'Please wait until the configured cancellation window has elapsed.', refund: 'Refund request failed.', extend: 'Rental extension failed.' },
    },
  },
