export default {
  ...
  sms: {
    ...
    user: {
      ...
      errors: { unavailable: 'SMS service is temporarily unavailable.', quote: 'Could not load quotes.', orders: 'Could not load orders.', purchase: 'Purchase failed; refresh orders to confirm the balance state.', insufficientStock: 'This channel does not have enough stock for the requested quantity.', cancel: 'Cancellation failed.', cancelTooEarly: 'Please wait until the configured cancellation window has elapsed.', refund: 'Refund request failed.', extend: 'Rental extension failed.' },
    },
  },
