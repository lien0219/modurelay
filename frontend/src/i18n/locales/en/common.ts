export default {
  ...
  verificationRecords: {
    ...
    summary: { title: 'Verification record summary', total: 'Total records', processing: 'Processing', success: 'Success', failed: 'Failed', refunded: 'Refunded', totalAmount: 'Total amount', totalCost: 'Total cost', profit: 'Profit', grossAmount: 'Gross order amount', netRevenue: 'Net revenue', netProviderCost: 'Net provider cost', netProfit: 'Net profit' },
