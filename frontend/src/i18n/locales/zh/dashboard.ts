export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: '配置 Grok Build、Claude Code、Codex 或 OpenCode，让请求通过当前 ModuRelay Grok 分组发送。',
        claudeDescription: '配置 Claude Code，让 Messages API 请求通过当前 ModuRelay Grok 分组发送。',
        codexDescription: '配置 Codex，让 Responses API 请求通过当前 ModuRelay Grok 分组发送。',
