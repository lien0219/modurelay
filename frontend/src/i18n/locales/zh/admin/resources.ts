export default {
    resourceCenter: {
      title: '论坛管理',
      description: '管理论坛入口、发布规则与违规内容',
      enabled: '显示论坛入口',
      enabledHint: '关闭后用户侧栏隐藏入口，现有内容也不可访问。',
      forbidUrls: '禁止发布 URL 链接',
      forbidUrlsHint: '开启后帖子和评论中出现 http、https 或 www 链接会被拦截。',
      bannedWords: '违禁词',
      bannedWordsHint: '每行一个词，命中后自动禁止帖子或评论发布。',
      save: '保存设置',
      saved: '论坛设置已保存',
      posts: '帖子审核',
      comments: '评论审核',
      ...
      deletePost: '删除帖子',
      deleteComment: '删除评论',
      confirmDeletePost: '确定删除这篇帖子及其评论吗？',
      confirmDeleteComment: '确定删除这条评论吗？',
      author: '作者',
      status: '状态',
      createdAt: '发布时间',
      openForum: '进入论坛',
      ...
      startDate: '开始日期',
      endDate: '结束日期',
      selectPage: '选择本页可操作内容',
      batchDelete: '批量删除',
      confirmBatchDelete: '确定删除选中的 {count} 条内容吗？',
      batchDeleted: '已删除 {count} 条内容',
      noResults: '没有符合条件的内容',
    },
    scheduledTests: {
      title: '定时测试',
