export default {
  ...
  resourceCenter: {
    ...
    heroDescription: '在这里交流使用经验、分享最佳实践、提出问题，并与持续开发者一起构建更好的 AI 应用。',
    statsPosts: '帖子',
    statsCategories: '分类',
    statsUnread: '未读互动',
    statsVisible: '当前显示',
    ...
    guideEyebrow: '社区指南',
    guideTitle: '一起维护高质量交流',
    guideRespectTitle: '友善交流',
    guideRespectDescription: '尊重他人观点，聚焦问题与经验本身。',
    guideVerifyTitle: '分享经验',
    guideVerifyDescription: '尽量提供可复现背景与真实使用信息。',
    guideSafetyTitle: '独立核验',
    guideSafetyDescription: '涉及链接、账号、价格与服务时请自行核实。',
