export default {
  ...
  version: {
    ...
    rollbackConfirmMessage: '即将把独立部署的程序回退到 {version}，此操作会替换当前可执行文件。',
    rollbackWarning: '回退将下载所选版本并替换当前程序，完成后需重启服务',
    dockerRollbackWarning: '请在生产宿主机的 deploy 目录执行命令；脚本会检查健康状态，失败时自动恢复原镜像。',
    databaseRollbackNotice: '镜像或程序回退不会回退数据库；数据库迁移为仅向前执行，操作前必须确认兼容性并保留可恢复备份。',
    rollingBack: '正在回退...',
    ...
    dockerUpdateAvailable: '生产镜像 {version} 可用',
    dockerHostRequired: 'Docker 部署必须由宿主机完成，应用容器不会直接控制 Docker。',
    hostDeployCommand: '宿主机部署命令',
    deployScript: '脚本部署',
    deployDocker: 'Docker',
  ...
  resourceCenter: {
    title: '论坛',
    description: '分享经验、交流思路，一起解决问题',
    disclaimer: '社区内容由用户发布，请注意甄别信息并保护个人隐私。仅带有“管理员”身份标识的账户代表 ModuRelay 官方。',
    categories: '分类',
    allCategories: '全部帖子',
    latest: '最新发布',
    popular: '最多点赞',
    ...
    heroEyebrow: 'ModuRelay 社区',
    heroTitle: '连接开发者，分享 AI 的更多可能',
    heroDescription: '在这里交流使用心得、分享实战经验、提出问题，与更多开发者一起学习、协作与成长。',
    statsPosts: '帖子',
    statsCategories: '分类',
    statsUnread: '未读互动',
    statsVisible: '当前显示',
    activityEyebrow: '社区动态',
    guideEyebrow: '社区指南',
    guideTitle: '一起保持友善、实用的交流',
    guideRespectTitle: '友善交流',
    guideRespectDescription: '尊重不同观点，围绕问题和经验本身展开讨论。',
    guideVerifyTitle: '分享经验',
    guideVerifyDescription: '欢迎分享真实使用体验、解决思路和可复现的实践信息。',
    guideSafetyTitle: '注意甄别信息',
    guideSafetyDescription: '涉及链接、账号、价格和服务信息时，请核实后再操作。',
    categoryEyebrow: '主题导航',
    sortLabel: '帖子排序',
    emptyTitle: '暂无帖子',
    composerEyebrow: '创建讨论',
    composerDescription: '清晰的标题与上下文能帮助社区更快理解你的问题。',
    postTitlePlaceholder: '用一句话概括你想讨论的主题',
    composerSafetyHint: '请勿发布敏感凭证、密钥或未经核实的交易信息。',
    discussionEyebrow: '讨论',
    noCommentsTitle: '暂无评论',
    commentSafetyHint: '请保持讨论友善，并避免粘贴敏感信息。',
  },
