export default {
  ...
  recharge: {
    ...
    openInNewTab: '新窗口打开',
    notEnabledTitle: '该功能未开启',
    notEnabledDesc: '管理员暂未开启充值中心入口，请联系管理员。',
    notConfiguredTitle: '充值页面链接未配置',
    notConfiguredDesc: '管理员已开启入口，但尚未配置充值页面链接，请联系管理员。'
  },
  ...
  resourceCenter: {
    title: '论坛',
    description: '发布帖子、交流经验并分享实用资源',
    disclaimer: '免责声明：内容由社区用户发布，仅带有“管理员”身份标识的账户代表 ModuRelay 官方。请自行核验链接、账号、价格和服务信息。',
    categories: '分类',
    allCategories: '全部帖子',
    latest: '最新发布',
    popular: '最多点赞',
    ...
    notifications: '互动提醒',
    markAllRead: '全部已读',
    noNotifications: '暂无互动提醒',
    notificationComment: '{actor} 评论了你的帖子',
    notificationReply: '{actor} 回复了你的评论',
    official: '官方管理员',
    member: '用户',
    views: '浏览',
    comments: '评论',
    ...
    blockedContent: '内容包含违禁词或链接，暂不能发布。',
    titleTooLong: '帖子标题不能超过 120 个字。',
    contentTooLong: '内容不能超过 10,000 个字；评论不能超过 2,000 个字。',
    loadMore: '加载更多帖子',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 ModuRelay',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">ModuRelay 是开源多模型接入、路由、账号池、计量与 API 管理平台。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 ModuRelay',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 ModuRelay AI 网关。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
