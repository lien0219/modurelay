export default {
  ...
  sms: {
    ...
    user: {
      ...
      refreshData: '刷新数据',
      stepChannelTitle: '渠道选择',
      stepChannelDescription: '选择接入渠道，不同渠道的号码资源可能有所不同。',
      publicChannels: '公开通道',
      channelReady: '稳定可用',
      channelReadySelected: '资源充足',
      stepServiceTitle: '选择服务',
      stepServiceDescription: '选择需要接收验证码的网站 / APP / 平台。',
      stepCountryTitle: '选择国家 / 地区',
      stepCountryDescription: '选择号码所属的国家或地区。',
      stepConfirmTitle: '确认选择',
      stepConfirmDescription: '确认以下信息，获取报价后将为您分配临时号码。',
      stepConfirmRentalDescription: '确认以下信息，选择时长和数量后完成长期号码购买。',
      quoteOptionsEyebrow: '实时报价',
      quoteOptionsTitle: '其他可用报价',
      liveOrdersTitle: '接码中 ({count})',
      liveOrdersDescription: '验证码会自动刷新，无需手动重复请求。',
      channel: '渠道',
      recentSuccess: '最近成功',
      unavailable: '暂未开放',
      ...
      actions: '操作',
      batchPurchase: '批量购买',
      capabilities: { cancel: '支持取消', noCancel: '不支持取消', refund: '支持自动退款', noRefund: '未收到短信时取消会自动释放余额；短信已送达后不支持自动退款', cancelRefund: '未收到验证码之前允许取消订单并自动退款' },
      quantity: '购买数量',
      ...
      restoreRentalConfirmMessage: '将恢复 {service} 长期号码，恢复时长约 {days} 天，费用 {price} 美元。恢复后可能分配新的号码，确认继续吗？',
      ...
      provider: '渠道', selectProvider: '选择渠道', selected: '已选择',
  ...
  verificationRecords: {
    ...
    outcomes: { processing: '处理中', success: '成功', failed: '失败', refunded: '已退款', free: '免费', cancelled: '已取消', expired: '已过期' },
    ...
    summary: { title: '接码记录汇总', total: '记录总数', processing: '处理中', success: '成功', failed: '失败', refunded: '退款', free: '免费', totalAmount: '总金额', totalCost: '总成本', profit: '利润', grossAmount: '订单毛额', netRevenue: '净收入', netProviderCost: '净供应商成本', netProfit: '净利润' },
    analytics: { userTitle: '接码成功率看板', userDescription: '按当前筛选条件查看不同接码方式、平台与国家 / 地区的成功率表现。', adminTitle: '成功率与利润看板', adminDescription: '按当前筛选条件统计接码表现，并核对净收入、净供应商成本与净利润。财务统计按真实结算账本计算；历史账本或供应商仅提供估算成本时会标记“估算”。', terminalHint: '成功率不包含处理中和免费结束记录', byType: '不同接码形式成功率', byPlatform: '不同平台成功率', byCountry: '不同国家成功率', successRate: '成功率', profitTitle: '按币种统计毛额、净收入、净成本与净利润', currency: '币种', empty: '当前筛选条件下暂无已完成样本' },
