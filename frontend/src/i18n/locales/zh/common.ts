export default {
  ...
  verificationRecords: {
    ...
    summary: { title: '接码记录汇总', total: '记录总数', processing: '处理中', success: '成功', failed: '失败', refunded: '退款', totalAmount: '总金额', totalCost: '总成本', profit: '利润', grossAmount: '订单毛额', netRevenue: '净收入', netProviderCost: '净供应商成本', netProfit: '净利润' },
