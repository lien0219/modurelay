export default {
  ...
  verificationRecords: {
    ...
    analytics: { title: '成功率与利润看板', description: '按当前筛选条件统计接码形式、平台与手机接码国家的表现。财务统计按真实结算账本计算；历史账本或供应商仅提供估算成本时会标记“估算”。', terminalHint: '成功率不包含仍在处理中的记录', byType: '不同接码形式成功率', byPlatform: '不同平台成功率', byCountry: '不同国家成功率', successRate: '成功率', profitTitle: '按币种统计毛额、净收入、净成本与净利润', currency: '币种', empty: '当前筛选条件下暂无已完成样本' },
