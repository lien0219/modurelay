...
func (_q *SmsProviderQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *SmsProviderQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *SmsProviderQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *SmsProviderQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *SmsProviderQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *SmsProviderQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SmsProviderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(smsprovider.Table, smsprovider.Columns, sqlgraph.NewFieldSpec(smsprovider.FieldID, field.TypeInt64))
	_spec.From = _q.sql
...
func (_q *SmsProviderQuery) ForUpdate(opts ...sql.LockOption) *SmsProviderQuery {
...
func (_q *SmsProviderQuery) ForShare(opts ...sql.LockOption) *SmsProviderQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
