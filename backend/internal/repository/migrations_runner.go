...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// 242 was applied by an earlier Email verification build before the
	// migration gained its current idempotent seed updates. The schema remains
	// compatible; accept only that historical checksum for this exact file.
	"242_email_service_foundation.sql": newMigrationChecksumCompatibilityRule("ce3fa28d8001c2e4302afe643e24497ac5a6bd3bb9f8e5195149d959158a1684", "a3d5992e6261725ca16d8809b89988711e2d3d55b32ff8b27d893a40550386ac"),
	// 247 was applied to the existing local acceptance database before the
	// migration file was normalized; accept only that exact historical checksum.
	"247_sms_provider_mapping_seeds.sql": newMigrationChecksumCompatibilityRule("a6c6428ff1dd35688c21387e687390053ea82cafde338edc3f47e7ecad81efaf", "e5e3acbc49f0d47e1378922778839e7c5c857ebbfe54f7a911b9ff1e02a4ef29"),
}
