...
var (
	resourceEmailIdentityPattern   = regexp.MustCompile(`^[^\s@]+@[^\s@]+\.[^\s@]+package service
...
var resourceURLPattern = regexp.MustCompile(`(?i)(?:https?://|www\.)[^\s<]+`)
	...
	resourcePhoneIdentityPattern   = regexp.MustCompile(`^\+?[0-9][0-9\s().-]{5,}[0-9]package service
...
var resourceURLPattern = regexp.MustCompile(`(?i)(?:https?://|www\.)[^\s<]+`)
	...
	resourceNumericIdentityPattern = regexp.MustCompile(`^[0-9]{6,}package service
