...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/lien0219/modurelay/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/lien0219/modurelay/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 ModuRelay 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the ModuRelay Deployment and Operation Compliance Commitment"
