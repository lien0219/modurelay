...
func TestMergePreservingSensitiveCreds_PreservesSensitiveWhenIncomingMissing(t *testing.T) {
	existing := map[string]any{
		...
		"access_token":                     "at-old",
		"api_key":                          "sk-old",
		NewAPIUserAccessTokenCredentialKey: "new-api-pat-old",
	...
	require.Equal(t, "new-api-pat-old", out[NewAPIUserAccessTokenCredentialKey])
...
func TestIsSensitiveCredentialKey(t *testing.T) {
	...
	require.True(t, IsSensitiveCredentialKey(NewAPIUserAccessTokenCredentialKey))
